...
if __name__ == '__main__':
    ...
    for sample_idx in sample_indices[start_idx: end_idx+1]:
        ...
        seg = np.load(join(dir_data_out, '%05d_mseg.npy' % sample_idx))
        ...
        depth_map, flow_lidar, msk_map_low_h, msk_map_in = cal_depthMap_flow(x1, y1, depth1, x2, y2, depth2, msk_low_h, msk_in, downsample_scale=2, y_cutoff=34)
                
        depth_map, msk_d1 = filter_occlusion_by_bbox(depth_map, seg, msk_map_in, x_cn, y_cn, depth_cn, msk_cn, downsample_scale=2, y_cutoff=34)
        ...
        uv2 = lidarFlow2uv(flow_lidar, K, depth_map, downsample_scale=2, y_cutoff=34)
